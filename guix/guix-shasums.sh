...
# script to generate Guix build output checksums
# can output in markdown format for easy inclusion in release notes
# or plain text for verification purposes
